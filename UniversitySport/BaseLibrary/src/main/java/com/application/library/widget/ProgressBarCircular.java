 ...
 * Todd Davies' Progress Wheel https://github.com/Todd-Davies/ProgressBarCircular
 *
...
public class ProgressBarCircular extends View {
  ...
  private void parseAttributes(TypedArray a) {
    ...
    circleRadius =
        (int) a.getDimension(R.styleable.ProgressBarCircular_matProg_circleRadius, circleRadius);
