...
public class ArcProgress extends View {
    ...
    private boolean arc_has_center = true;
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = PhoneUtil.sp2px(getResources(), 18);
        min_size = (int) PhoneUtil.dp2px(getResources(), 100);
        default_text_size = PhoneUtil.sp2px(getResources(), 40);
        default_suffix_text_size = PhoneUtil.sp2px(getResources(), 15);
        default_suffix_padding = PhoneUtil.dp2px(getResources(), 4);
        default_suffix_text = "%";
        default_bottom_text_size = PhoneUtil.sp2px(getResources(), 10);
        default_stroke_width = PhoneUtil.dp2px(getResources(), 4);
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        arc_has_center = attributes.getBoolean(R.styleable.ArcProgress_arc_has_center, true);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (arc_has_center && !TextUtils.isEmpty(text)) {
            textPaint.setColor(textColor);
            textPaint.setTextSize(textSize);
