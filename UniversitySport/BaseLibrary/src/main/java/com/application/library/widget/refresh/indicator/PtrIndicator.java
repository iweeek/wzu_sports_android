package com.application.library.widget.refresh.indicator;
...
public class PtrIndicator {
    ...
    public int getSearchHeight() {
        return mSearchHeight;
    }

    public void setSearchHeight(int mSearchHeight) {
        this.mSearchHeight = mSearchHeight;
    }
...
//        if (isShowSearchBar) {
//            return mCurrentPos > mSearchHeight;
//        } else {
...
//        }
    ...
    public boolean hasJustLeftStartPosition() {
        if (isShowSearchBar) {
            return mLastPos == mSearchHeight && hasLeftStartPosition();
        } else {
    ...
    public boolean hasJustBackToStartPosition() {
        if (isShowSearchBar) {
            return mLastPos != mSearchHeight && isInStartPosition();
        } else {
