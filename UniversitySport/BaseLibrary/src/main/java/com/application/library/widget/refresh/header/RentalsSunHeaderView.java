...
import com.application.library.widget.refresh.indicator.PtrTensionIndicator;
...
public class RentalsSunHeaderView extends View implements PtrUIHandler {
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        mDrawable.start();
        float percent = mPtrTensionIndicator.getOverDragPercent();
        mDrawable.offsetTopAndBottom(mPtrTensionIndicator.getCurrentPosY() - mPtrTensionIndicator.getSearchHeight());
