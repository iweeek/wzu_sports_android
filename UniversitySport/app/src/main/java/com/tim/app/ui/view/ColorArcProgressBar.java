...
public class ColorArcProgressBar extends View {
    ...
    private String longDegreeColor = "#547397";
    private String shortDegreeColor = "#547397";
    private String bgArcColor = "#547397";
    ...
    protected void onDraw(Canvas canvas) {
        ...
        matrix.setRotate(100, centerX, centerY);
